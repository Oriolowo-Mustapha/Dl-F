    ...
    describe('pass-through behavior', () => {
        it('should pass through when withCDN=false', async () => {
            ...
            const mockBaseRetriever = {
                fetchPiece: async (pieceCid, client, options) => {
                    baseCalled = true;
        ...
        it('should propagate abort signal to base retriever', async () => {
            ...
            const mockBaseRetriever = {
                fetchPiece: async (_pieceCid, _client, options) => {
    ...
    describe('CDN handling', () => {
        it('should respond and not pass through', async () => {
            ...
            global.fetch = async (url) => {
                cdnCalled = true;
                assert.strictEqual(url, `https://0xClient.calibration.filcdn.io/${mockPieceCID.toString()}`, 'CDN URL should be constructed correctly');
                return cdnResponse;
            };
            try {
                const cdnRetriever = new FilCdnRetriever(mockBaseRetriever, 'calibration');
