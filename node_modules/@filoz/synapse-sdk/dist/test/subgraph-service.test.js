...
describe('SubgraphService', () => {
    ...
    const mockPieceCID = asPieceCID('bafkzcibcoybm2jlqsbekq6uluyl7xm5ffemw7iuzni5ez3a27iwy4qu3ssebqdq');
    let originalFetch;
    beforeEach(() => {
    ...
    describe('constructor', () => {
        ...
        it('should throw an error for invalid config', () => {
            assert.throws(() => new SubgraphService({}), /Invalid configuration: provide either endpoint or complete goldsky config/);
        });
    });
    describe('getApprovedProvidersForPieceCID', () => {
        ...
        it('should handle invalid PieceCID', async () => {
            ...
            try {
                const service = new SubgraphService({ endpoint: mockEndpoint });
                await service.getApprovedProvidersForPieceCID(asPieceCID('invalid'));
                assert.fail('should have thrown');
            }
            catch (err) {
                assert.match(err.message, /Invalid PieceCID/);
            }
            finally {
                global.fetch = originalFetch;
            }
